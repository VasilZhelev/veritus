...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.features.title": "Everything you need to buy with confidence",
    "home.features.subtitle": "Powerful AI tools that give you an unfair advantage in the used car market.",
    "home.feat1.title": "AI Damage Detection",
    "home.feat1.desc": "Instantly spot hidden scratches, dents, and frame damage from ordinary listing photos.",
    "home.feat2.title": "Global VIN History",
    "home.feat2.desc": "Cross-reference databases to catch mileage rollbacks and stolen vehicles before you buy.",
    "home.feat3.title": "Smart Comparisons",
    "home.feat3.desc": "Put two cars head-to-head and let our AI calculate the true cost of ownership.",
    "home.howItWorks.title": "How it works",
    "home.howItWorks.subtitle": "Three simple steps to total peace of mind.",
    "home.step1.title": "1. Paste a link",
    "home.step1.desc": "Found a car you like? Just paste the URL from any major marketplace.",
    "home.step2.title": "2. We analyze it",
    "home.step2.desc": "Our AI scans the images, decodes the VIN, and reads the dealer notes in seconds.",
    "home.step3.title": "3. Get insights",
    "home.step3.desc": "Chat with our AI about the car, compare it, and make a smart decision.",
    "home.cta.title": "Ready to find your perfect car?",
    "home.cta.subtitle": "Join thousands of smart buyers using Veritus today.",
    "home.cta.button": "Start Analyzing",
  ...
  bg: {
    ...
    "home.features.title": "Всичко необходимо за уверена покупка",
    "home.features.subtitle": "Мощни AI инструменти, които ви дават предимство на пазара за употребявани автомобили.",
    "home.feat1.title": "AI Откриване на повреди",
    "home.feat1.desc": "Моментално открийте скрити драскотини, вдлъбнатини и щети от обикновени снимки от обяви.",
    "home.feat2.title": "Глобална VIN история",
    "home.feat2.desc": "Кръстосана проверка на бази данни за улавяне на превъртян пробег и крадени автомобили.",
    "home.feat3.title": "Умни сравнения",
    "home.feat3.desc": "Изправете два автомобила един срещу друг и оставете AI да изчисли истинската цена на притежание.",
    "home.howItWorks.title": "Как работи",
    "home.howItWorks.subtitle": "Три прости стъпки за пълно спокойствие.",
    "home.step1.title": "1. Поставете линк",
    "home.step1.desc": "Намерихте кола, която ви харесва? Просто поставете URL от всеки голям пазар.",
    "home.step2.title": "2. Ние я анализираме",
    "home.step2.desc": "Нашият AI сканира снимките, декодира VIN и чете бележките на търговеца за секунди.",
    "home.step3.title": "3. Получете прозрения",
    "home.step3.desc": "Чатнете с нашия AI за колата, сравнете я и вземете умно решение.",
    "home.cta.title": "Готови ли сте да намерите перфектната кола?",
    "home.cta.subtitle": "Присъединете се към хилядите умни купувачи, използващи Veritus днес.",
    "home.cta.button": "Започнете анализ",
